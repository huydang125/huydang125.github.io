...
var TaskService = /** @class */ (function () {
    function TaskService(http) {
        ...
        // read about the HttpHeaders(this is what in PostMan to send data to server)
    ...
    // These method will talk/send_data to the back end: 
